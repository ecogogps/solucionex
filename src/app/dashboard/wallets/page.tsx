        ...
        <nav className="flex-1 space-y-2">
          ...
          <Link href="/dashboard/wallets">
            <Button variant="ghost" className="w-full justify-start gap-3 bg-white/10 text-white hover:bg-white/20">
              <Wallet className="h-5 w-5 text-accent" /> Billeteras
            </Button>
          </Link>
                      ...
                      <TableRow key={wallet.perfil_id} className="border-white/10 hover:bg-white/5 transition-colors">
                        ...
                        <TableCell>
                          <span className={cn(
                            ...
                            wallet.por_acreditar > 0 ? "text-red-400" : "text-slate-500"
                          )}>
                        ...
                        <TableCell>
                          <span className={cn(
                            "font-mono font-black",
                            wallet.cash_acumulado > 0 ? "text-orange-400" : "text-slate-500"
                          )}>
                ...
                <div className="flex-1 overflow-hidden flex flex-col">
                  <div className="p-6 pb-2 flex items-center justify-between shrink-0">
                    ...
                    <Button 
                      ...
                      onClick={() => {
                        // Navegar a liquidaciones (futura pantalla)
                        toast({ title: "Acceso Directo", description: "Navegando a Liquidaciones con este perfil..." });
                      }}
                    >
                      IR A LIQUIDACIÓN
                    </Button>
                          ...
                          <div key={mov.id} className="bg-white/5 border border-white/5 rounded-lg p-3 space-y-2 group">
                            <div className="flex justify-between items-start">
                              ...
                              <div className="text-right">
                                <p className={cn(
                                  "text-sm font-black",
                                  mov.monto > 0 ? "text-emerald-400" : "text-red-400"
                                )}>
                                  {mov.monto > 0 ? '+' : ''}{Number(mov.monto).toFixed(2)}
                                </p>
                              </div>
                            </div>
